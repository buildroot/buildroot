...
rm -rf $TARGET_DIR/usr/bin/raspiyuv
rm -rf $TARGET_DIR/usr/bin/raspividyuv
rm -rf $TARGET_DIR/usr/bin/raspivid
rm -rf $TARGET_DIR/usr/bin/raspistill
rm -rf $TARGET_DIR/usr/bin/dtoverlay
