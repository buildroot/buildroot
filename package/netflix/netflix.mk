...
NETFLIX_VERSION = f402030f6b52a5c6726bb891174abb7b305ff5c7
...
NETFLIX_CONF_OPTS = \
	...
	-DGIBBON_BSDIFF=OFF \
	-DGIBBON_SCRIPT_JSC_JIT=ON \
	-DGIBBON_SCRIPT_JSC_BACKDOOR=OFF \
	-DGIBBON_SCRIPT_JSC_BACKDOOR_DEBUGGER=OFF \
	-DNRDP_HAS_IPV6=OFF \
	...
	-DNRDP_MDX_ENABLED=ON \
	-DNRDP_WEBSERVER_ENABLED=OFF \
	-DNRDP_CRASH_REPORTING_BREAKPAD=OFF \
...
NETFLIX_FLAGS += -DUSE_FUSION_SINK=1
endif
