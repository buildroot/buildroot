...
NETFLIX_VERSION = 17c010ace6b24731ebfa5f9d0c14b8c7414504f5
NETFLIX_SITE = git@github.com:Metrological/netflix.git
NETFLIX_SITE_METHOD = git
NETFLIX_LICENSE = PROPRIETARY
NETFLIX_DEPENDENCIES = freetype icu jpeg libpng libmng webp harfbuzz expat openssl c-ares libcurl graphite2 webp
...
NETFLIX_CONF_OPTS += -DGIBBON_INPUT=compositor-client
...
ifeq ($(BR2_PACKAGE_WESTEROS)$(BR2_PACKAGE_WPEFRAMEWORK_COMPOSITOR),yy)
NETFLIX_CONF_OPTS += \
	-DGIBBON_GRAPHICS=compositor-client
