...
WAYLAND_EGL_BNXS_VERSION = ddaa80bb9c3475e8316e768acd9b3fad653abbbd
...
ifeq ($(BR2_PACKAGE_BCM_REFSW_18_2),y)
	WAYLAND_EGL_BNXS_CFLAGS += -DEMBEDDED_SETTOP_BOX -DNXPL_PLATFORM_NSC -DNXCLIENT_SUPPORT -DNO_OPENVG
	WAYLAND_EGL_BNXS_CXXFLAGS += -DEMBEDDED_SETTOP_BOX -DNXPL_PLATFORM_NSC -DNXCLIENT_SUPPORT -DNO_OPENVG
endif
