...
XFONT_FONT_MUTT_MISC_VERSION = 1.0.4
XFONT_FONT_MUTT_MISC_SOURCE = font-mutt-misc-$(XFONT_FONT_MUTT_MISC_VERSION).tar.xz
XFONT_FONT_MUTT_MISC_SITE = https://xorg.freedesktop.org/archive/individual/font
