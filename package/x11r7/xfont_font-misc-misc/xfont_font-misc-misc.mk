...
XFONT_FONT_MISC_MISC_VERSION = 1.1.3
XFONT_FONT_MISC_MISC_SOURCE = font-misc-misc-$(XFONT_FONT_MISC_MISC_VERSION).tar.xz
XFONT_FONT_MISC_MISC_SITE = https://xorg.freedesktop.org/archive/individual/font
