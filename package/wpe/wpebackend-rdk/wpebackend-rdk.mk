...
ifeq ($(BR2_PACKAGE_RPI_FIRMWARE_VARIANT_PI4)x,yx)
WPEBACKEND_RDK_POST_PATCH_HOOKS += WPEBACKEND_RDK_POST_PATCH_FIXUP
define WPEBACKEND_RDK_POST_PATCH_FIXUP
[ -d $(WPEBACKEND_RDK_PKGDIR)/$(WPEBACKEND_RDK_VERSION).pi4 ] && \
$(APPLY_PATCHES) $(@D) $(WPEBACKEND_RDK_PKGDIR)/$(WPEBACKEND_RDK_VERSION).pi4 *.patch.hooked
endef
endif
