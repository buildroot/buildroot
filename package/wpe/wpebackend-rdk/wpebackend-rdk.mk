...
WPEBACKEND_RDK_VERSION = 91bb2a743a22f6416aa12a1641c7a9c662d5f19b
...
ifeq ($(BR2_PACKAGE_BCM_WESTON),y)
    ...
    WPEBACKEND_RDK_DEPENDENCIES += wayland westeros wpeframework-plugins wayland-egl-bnxs bcm-refsw
    WPEBACKEND_RDK_FLAGS +=-DUSE_BACKEND_WPEFRAMEWORK=ON -DUSE_HOLE_PUNCH_GSTREAMER=OFF -DUSE_INPUT_LIBINPUT=OFF
else
