...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1),y)
NETWORKCONTROL_INTERFACES=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1_NAME)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1_MODE)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1_ADDRESS)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1_MASK)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE1_GATEWAY));
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2),y)
NETWORKCONTROL_INTERFACES+=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2_NAME)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2_MODE)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2_ADDRESS)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2_MASK)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE2_GATEWAY));
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3),y)
NETWORKCONTROL_INTERFACES+=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3_NAME)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3_MODE)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3_ADDRESS)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3_MASK)):$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_NETWORKCONTROL_INTERFACE3_GATEWAY));
endif
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_NETWORKCONTROL_INTERFACES='$(NETWORKCONTROL_INTERFACES)'
endif
