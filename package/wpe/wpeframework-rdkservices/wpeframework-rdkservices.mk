...
WPEFRAMEWORK_RDKSERVICES_VERSION = 8c1eb6665268da539d465753285d078cfed1ba4e
...
WPEFRAMEWORK_RDKSERVICES_CONF_OPTS += -DENABLE_OPEN_CDMI=ON
...
WPEFRAMEWORK_RDKSERVICES_CONF_OPTS += -DENABLE_MESSENGER=ON
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_SECURITYAGENT),y)
WPEFRAMEWORK_RDKSERVICES_CONF_OPTS += -DENABLE_SECURITY_AGENT=ON
endif
...
WPEFRAMEWORK_RDKSERVICES_CONF_OPTS += -DENABLE_DEVICE_IDENTIFICATION=ON
endif
