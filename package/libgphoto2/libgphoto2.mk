...
#
#############################################################
LIBGPHOTO2_VERSION= 212d6179fbd6b01ae2c089385f4ba9122da70f42
...
LIBGPHOTO2_DEPENDENCIES = libtool libusb libexif gettext
...
define LIBGPHOTO2_RUN_AUTORECONF
	cd $(@D) && $(HOST_DIR)/usr/bin/autoreconf -Wcross --verbose --force --install --symlink
endef
