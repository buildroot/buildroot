...
INTELCE_IDTS_COMMON_SITE = ${INTELCE_SDK_DIR}/idts_common
INTELCE_IDTS_COMMON_SITE_METHOD = local
INTELCE_IDTS_COMMON_LICENSE = PROPRIETARY
INTELCE_IDTS_COMMON_REDISTRIBUTE = NO
INTELCE_IDTS_COMMON_DEPENDENCIES += intelce-sdk intelce-pal intelce-osal intelce-idl openssl 
INTELCE_IDTS_COMMON_INSTALL_STAGING = YES
ifeq ($(BR2_PACKAGE_INTELCE_SDK_V21),y)
    INTELCE_IDTS_COMMON_DEPENDENCIES += intelce-graphics
